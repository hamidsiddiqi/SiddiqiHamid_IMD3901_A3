...
public class GameManager : NetworkBehaviour
{
    ...
    public TextMeshProUGUI p1Text;
    public TextMeshProUGUI p2Text;
    public TextMeshProUGUI winStatusText; // Drag your 'Win Status' text object here
    ...
    void Update()
    {
        p1Text.text = "Player 1 Buttons Left: " + p1Remaining.Value;
        p2Text.text = "Player 2 Buttons Left: " + p2Remaining.Value;
        ...
        {
            timerText.text = "Waiting for Player 2 to join...";
        }
    }
